...
from stilt import Simulation, Footprint
...
def get_footprint(
    ...
    if not footprint_in_time_range(
...
def load_footprint(sim: Simulation, resolution: str | None = None
    ) -> Footprint | None:
...
def footprint_in_time_range(footprint: Footprint,
